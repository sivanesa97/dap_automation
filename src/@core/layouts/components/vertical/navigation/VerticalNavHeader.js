        ...
        <Link href='/' passHref>
          <StyledLink>
            {(!navCollapsed || navHover) ? (
              <img src='/images/logo/wissend_logo.png' style={{ width: '90%', paddingLeft: '5%', paddingRight: '5%' }} />
              ) : (
              <img src='/images/logo/wissend_logo_short.png' style={{ maxWidth:'50px', paddingLeft: '5%', paddingRight: '5%' }} />
            )}
